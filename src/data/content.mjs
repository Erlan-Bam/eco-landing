export const content = {
  ru: {
    ...
    seo: {
      ...
      homeDescription: "Разработка экологических проектов, отчетности и разрешений для бизнеса по Казахстану. ТОО зарегистрировано в 2025 году, экспертный опыт с 2010 года.",
      servicesTitle: "Экологические услуги и цены | НДВ, ПУО, ОВОС, отчеты",
      servicesDescription: "Каталог экологических услуг: НДВ, ПУО, СЗЗ, ОВОС, ОоВВ, РООС, РСВ, отчеты 2-ТП и 4-ОС. Цены от 25 000 ₸ и стоимость по запросу."
    },
    home: {
      hero: {
      ...
      directions: [
        { title: "Проектная документация", text: "НДВ, СЗЗ, ОВОС, ОоВВ и РООС для объектов разных типов." },
        { title: "Отходы", text: "ПУО, инвентаризация отходов и паспорт опасных отходов." },
        { title: "Водопользование", text: "ВЗиП, НДС, удельные нормы и разрешение на специальное водопользование." },
  ...
  kz: {
    ...
    seo: {
      ...
      homeDescription: "Қазақстан бойынша бизнеске арналған экологиялық жобалар, есептілік және рұқсат құжаттары. ЖШС 2025 жылы тіркелген, сараптамалық тәжірибе 2010 жылдан бері.",
      servicesTitle: "Экологиялық қызметтер және бағалар | НДВ, ПУО, ОВОС, есептер",
      servicesDescription: "Экологиялық қызметтер каталогы: НДВ, ПУО, СҚА, ОВОС, ОоВВ, РООС, РСВ, 2-ТП және 4-ОС есептері. Бағалар 25 000 ₸ бастап және сұраныс бойынша."
    },
    home: {
      hero: {
        eyebrow: "Алматыдағы ЖШС · Қазақстан бойынша жұмыс",
      ...
      trustChips: ["БСН 250140022679", "Алматы", "Қазақстан бойынша", "2010 жылдан бергі тәжірибе", "Дс-Жм 10:00-18:00"],
      directionsTitle: "Бизнеске қажет экологиялық міндеттерді жабамыз",
      directions: [
        { title: "Жобалық құжаттама", text: "Әртүрлі нысандар үшін НДВ, СҚА, ОВОС, ОоВВ және РООС." },
        { title: "Қалдықтар", text: "ПУО, қалдықтарды түгендеу және қауіпті қалдықтар паспорты." },
        { title: "Су пайдалану", text: "Су қорғау аймақтары, НДС, үлестік нормалар және арнайы су пайдалану рұқсаты." },
